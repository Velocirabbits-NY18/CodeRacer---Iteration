        ...
        <div className = "login">
            <div className = "message">
                ...
                <div className = "signIn">
                  <a className = "githubText" href={"https://github.com/login/oauth/authorize?client_id=3b5392180e51bf2368e3&redirect_uri=http://localhost:3000/callback"}>
                    <span>Log in with Github</span>
                    <svg className = "githubIcon" width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px"  xmlSpace="preserve">
